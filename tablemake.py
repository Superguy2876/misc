...
effects = ["Roll on this table every round for 1 minute", 
...
# for each effect, put it in the form of '| i | {effect} |' where i is increasing by one.
for i , effect in enumerate(effects):
    effect_text += f'| {i+1} | {effect} |\n'
